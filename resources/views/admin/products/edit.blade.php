<x-app-layout>
    ...
    <section class="py-10 bg-gray-900 min-h-screen">
        <div class="max-w-3xl mx-auto bg-gray-800 p-8 rounded-2xl shadow-lg">
            <h2 class="text-3xl font-bold text-white mb-6 text-center">Edit Product</h2>
                ...
                @if ($product->image)
                    <div class="text-center">
                        <img src="{{ asset('storage/' . $product->image) }}" alt="Product Image"
                            class="w-48 h-48 object-cover mx-auto rounded-lg mb-4 border border-gray-600">
                    </div>
                @endif

                <!-- Upload New Image -->
                <div>
                    <label for="image" class="block text-gray-300 font-medium mb-2">Replace Image</label>
